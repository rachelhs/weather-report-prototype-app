...
import cloudRainThreatLow from '../../animations/06_Medium_Low_Weather_River.json'
...
import tsunamiFadeIn from '../../animations/08_Low_But_with_Energy_Fade_In.json'
import tsunamiEnergy from '../../animations/08_Low_But_with_Energy_Weather_River.json'
import tsunamiFadeOut from '../../animations/08_Low_But_with_Energy_River_Fade_Out.json'
import tornadoFadeIn from '../../animations/09_Suicidal_Fade_In.json'
import tornado from '../../animations/09_Suicidal_Weather_River.json'
import tornadoFadeOut from '../../animations/09_Suicidal_River_Fade_Out.json'
