        ...
        return (
            <div className='background-box'>
                ...
                <div className='info-box'>
                    <h1 className='header-text-spacing'>You have registered how you're feeling more than three times today.</h1>
                    <p>From feedback, we have set a limit on entering this 3 times a day</p>
                    <p>You can go to the home page</p>
                    <div className="button-container">
                        <Link to={{ pathname: '/home' }} className='next-button-dark'>HOME</Link>
                    </div>
                </div>
            </div>
        );
