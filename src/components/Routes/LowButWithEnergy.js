        ...
        return (
            <div>
                ...
                <div className='info-box'>
                    ...
                    <CSSTransition in={this.state.showRandomExercises} timeout={2000} classNames="fade" unmountOnExit onExited={() => this.askIfHelped()}><div className='exercise-container'><div>{SetExercises(this.state.exercise)}</div><button className='transparent-button' onClick={this.seenExercise}>next</button></div></CSSTransition>
