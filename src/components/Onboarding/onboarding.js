    ...
    render() {
        return (
            <div>
                ...
                <CSSTransition in={this.state.river} timeout={fadeTime} classNames="fade" unmountOnExit onEnter={() => { this.triggerTimeout('river') }} onExited={() => { this.show('environment') }}><div className='background-box-no-fade'><AnimationsLayered speeds={[1]} animations={['riverLevel']} /><div className='info-box'><h1 className="info-box-title">{data[9].onboarding.river}</h1></div></div></CSSTransition>
                <CSSTransition in={this.state.environment} timeout={fadeTime} classNames="fade" unmountOnExit onEnter={() => { this.triggerTimeout('environment') }} onExited={() => { this.show('plant') }}><div className='background-box-no-fade'><AnimationsLayered speeds={[1]} animations={['environment']} /><div className='info-box'><h1 className="info-box-title">{data[9].onboarding.environment}</h1></div></div></CSSTransition>
                <CSSTransition in={this.state.plant} timeout={fadeTime} classNames="fade" unmountOnExit onEnter={() => { this.triggerTimeout('plant') }} onExited={() => { this.show('seed') }}><div className='background-box-no-fade'><AnimationsLayered speeds={[1]} animations={['lilypad']} /><div className='info-box'><h1 className="info-box-title">{data[9].onboarding.plant}</h1></div></div></CSSTransition>
                ...
                <CSSTransition in={this.state.dropped} timeout={fadeTime} classNames="fade" unmountOnExit onEnter={() => { this.triggerTimeout('dropped') }} onExited={() => { this.show('dropped2') }}><div className='background-box-no-fade'><AnimationsLayered speeds={[1]} animations={['riverLevel']} /><div className='info-box'><h1 className="info-box-title">{data[9].onboarding.putLily}</h1></div></div></CSSTransition>
